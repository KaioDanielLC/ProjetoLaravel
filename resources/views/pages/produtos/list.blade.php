    ...
    <div class=" flex justify-center ">
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-10 w-5/6">
            <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400 text-center ">
                <thead class="text-xs text-gray-700 uppercase dark:bg-primaria dark:text-segundaria">
                    <tr>
                ...
                <tbody>
                    ...
                    <tr class="odd:dark:bg-[#303030] even:dark:bg-primaria ">
                        ...
                        <th>
                            <a class="text-gray-100 hover:text-segundaria" href="#">Edit</a> | <a class="text-gray-100 hover:text-segundaria" href="{{route('produtos.show',[$produtos->id])}}">Show</a>
                        </th>
