        ...
        <div>
            ...
            <form action="{{route('categorias.destroy', ['categoria' =>$categoria->id])}}" method="POST">
                ...
                <div class="text-center text-white text-xl mt-5">
                    <a href="{{route('categorias.index')}}" class="focus:outline-none text-white bg-yellow-400 hover:bg-yellow-500 focus:ring-4 focus:ring-yellow-300 font-medium rounded-lg text-sm px-5 py-3 me-2 mb-2 dark:focus:ring-yellow-900">Cancelar</a>
