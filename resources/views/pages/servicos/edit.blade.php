            ...
            <form action="{{route('servicos.update' , ['servico' => $servico->id])}}" method="post">
                ...
                <div class="grid gap-4 ">
                    ...
                    <div>
                        ...
                        <input value="{{$servico->preco}}" name="tempo" id="tempo" type="number" class="focus:border-segundaria focus:ring-segundaria rounded-lg min-w-full bg-primaria text-white">
                    </div>
                    <div>
